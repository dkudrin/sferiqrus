...
/**
 * Before Latest publications section
 *
 * HTML context: before `.latest-publications`
 */
function zerif_before_latest_publications_trigger() {
	do_action( 'zerif_before_latest_publications' );
}

/**
 * After Latest publications section
 *
 * HTML context: after `.latest-publications`
 */
function zerif_after_latest_publications_trigger() {
	do_action( 'zerif_after_latest_publications' );
}
