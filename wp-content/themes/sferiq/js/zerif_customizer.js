jQuery(document).ready(function() {
	...
	if( jQuery( ".zerif-upsells" ).length ) {
		...
		jQuery('.zerif-upsells').append('<a style="width: 80%; margin: 5px auto 5px auto; display: block; text-align: center;" href="http://themeisle.com/documentation-sferiq" class="button" target="_blank">{documentation}</a>'.replace('{documentation}', zerifLiteCustomizerObject.documentation));
